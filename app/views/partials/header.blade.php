...
<nav id="site-menu" class="dropdown-menu padding">
	<ul class="list">
		...
		<li> {{ HTML::link('users/' . Auth::user()->id . '/trips', 'Your Trips', array('class'=>'button input_text')) }} </li>
		<li> {{ HTML::link('users/' . Auth::user()->id, 'Profile', array('class'=>'button input_text')) }} </li>
